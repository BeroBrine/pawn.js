-- CreateEnum
CREATE TYPE "GameStatus" AS ENUM ('COMPLETED', 'IN_PROGRESS', 'ABANDONDEND');
...
CREATE TABLE "Game" (
    ...
    "defaultFen" TEXT NOT NULL DEFAULT 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
